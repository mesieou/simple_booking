...
CREATE TABLE IF NOT EXISTS "public"."notifications" (
    ...
    "createdAt" timestamp with time zone DEFAULT "now"() NOT NULL,
    "businessId" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "chatSessionId" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "users_whatsAppNumberNormalized_key" UNIQUE ("whatsAppNumberNormalized");
...
ALTER TABLE ONLY "public"."availabilitySlots"
    ADD CONSTRAINT "availabilitySlotss_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "public"."users"("id");
...
CREATE POLICY "admin_provider_availability_business_providers" ON "public"."availabilitySlots" TO "authenticated" USING ((("public"."get_my_role"() = 'admin/provider'::"text") AND "public"."availability_belongs_to_business_provider"("id"))) WITH CHECK ((("public"."get_my_role"() = 'admin/provider'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "availabilitySlots"."providerId") AND ("users"."businessId" = "public"."get_my_business_id"()))))));
...
CREATE POLICY "provider_availability_own_delete" ON "public"."availabilitySlots" FOR DELETE TO "authenticated" USING ((("public"."get_my_role"() = 'provider'::"text") AND ("providerId" = "auth"."uid"())));



CREATE POLICY "provider_availability_own_insert" ON "public"."availabilitySlots" FOR INSERT TO "authenticated" WITH CHECK ((("public"."get_my_role"() = 'provider'::"text") AND ("providerId" = "auth"."uid"())));



CREATE POLICY "provider_availability_own_select" ON "public"."availabilitySlots" FOR SELECT TO "authenticated" USING ((("public"."get_my_role"() = 'provider'::"text") AND ("providerId" = "auth"."uid"())));



CREATE POLICY "provider_availability_own_update" ON "public"."availabilitySlots" FOR UPDATE TO "authenticated" USING ((("public"."get_my_role"() = 'provider'::"text") AND ("providerId" = "auth"."uid"()))) WITH CHECK ((("public"."get_my_role"() = 'provider'::"text") AND ("providerId" = "auth"."uid"())));
