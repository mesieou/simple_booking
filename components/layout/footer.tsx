      ...
      <div className="w-full max-w-4xl mx-auto px-4 py-10 flex flex-col items-center justify-center">
        ...
        <nav className="mb-6">
          <ul className="flex flex-wrap gap-8 justify-center items-center text-base text-gray-200 font-medium">
            <li><Link href="/features" className="hover:text-yellow-400 transition-colors" tabIndex={0} aria-label={t('features')}>{t('features')}</Link></li>
            <li><Link href="/pricing" className="hover:text-yellow-400 transition-colors" tabIndex={0} aria-label={t('prices')}>{t('prices')}</Link></li>
            <li><Link href="/contact" className="hover:text-yellow-400 transition-colors" tabIndex={0} aria-label={t('contact')}>{t('contact')}</Link></li>
            <li><Link href="/faq" className="hover:text-yellow-400 transition-colors" tabIndex={0} aria-label={t('questions')}>{t('questions')}</Link></li>
            <li><Link href="/privacy" className="hover:text-yellow-400 transition-colors" tabIndex={0} aria-label={t('privacy')}>{t('privacy')}</Link></li>
            <li><Link href="/terms" className="hover:text-yellow-400 transition-colors" tabIndex={0} aria-label={t('terms')}>{t('terms')}</Link></li>
          </ul>
        </nav>
        ...
        <span className="text-sm text-gray-400 text-center block">
          © {new Date().getFullYear()} <Link href="/" className="hover:underline">Skedy™</Link>. {t('rights')}
        </span>
      </div>
    </footer>
  )
