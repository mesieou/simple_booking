...
<body>
    <div class="whatsapp-widget" id="whatsapp-widget">
        <div class="tooltip" id="tooltip">💬 Need help?</div>
        ...
        function openWhatsApp() {
            ...
            const message = encodeURIComponent('Hi! I found you through your website. I\\'d like to know more about your services.');
