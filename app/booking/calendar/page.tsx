...
export default function BookingCalendarStep() {
  ...
  const handleContinue = () => {
    router.push(`/booking/moving?origen=${encodeURIComponent(origen)}&destino=${encodeURIComponent(destino)}&arrival=${encodeURIComponent(arrival)}&size=${encodeURIComponent(sizeKey)}`);
  };
