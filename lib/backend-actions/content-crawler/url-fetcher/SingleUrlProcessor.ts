import { CrawlConfig, ExtractedPatterns } from '@/lib/general-config/general-config';
import { logger as globalLoggerInstance } from '../process-content/logger'; // Use the global logger instance
import { 
    saveRawHtml, 
    saveCleanedTextForUrl, 
    getUrlIdentifier 
} from '../process-content/logger-artifact-savers';
