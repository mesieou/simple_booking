interface DialogueState {
  ...
  interface LLMContext {
    ...
    // Current booking progress (if any)
    currentBooking?: {
      serviceId?: string;
      serviceName?: string;
      date?: string;
    ...
    // Current task outputs from handlers
    taskOutputs: {
      chitchat?: string;
      faq?: string;
      booking?: string;
  ...
  interface SystemTracking {
    // What's the user currently doing?
    activeTask: 'booking' | 'asking_questions' | 'chatting' | null;
    
    // Is there a booking in progress?
