import { CrawlConfig, CATEGORY_DISPLAY_NAMES, EMBEDDING_CONFIG } from '@/lib/config/config';
import { generateContentHash, runConcurrentTasks } from '@/lib/bot/content-crawler/utils';
import { CrawlSession, CrawlSessionData } from '@/lib/models/crawl-session';
import { logger } from '@/lib/bot/content-crawler/process-content/logger';
import { embeddingInQueue } from './embedding-creator';
import { Document, DocumentData } from '@/lib/models/documents';
import { EmbeddingData } from '../../../../models/embeddings';
import {
