import { PROCESS_CONTENT_CONFIG } from '@/lib/config/config'; // For PROGRESS_UPDATE_INTERVAL
...
// Configuration constants (if any specific to logger module itself)
export const LOGGER_PROGRESS_UPDATE_INTERVAL = PROCESS_CONTENT_CONFIG.LOGGER.PROGRESS_UPDATE_INTERVAL; 