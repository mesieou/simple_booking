export const BOOKING_TRANSLATIONS = {
  en: {
    ...
    MESSAGES: {
      ...
      BOOK_SERVICE: 'Great {name}! Let\'s get you a quote for {service}.',
      ...
      QUOTE_CONFIRMED: 'Perfect {name}! Your quote is ready. Would you like to proceed with booking?',
      ...
      ACCOUNT_CREATED: 'Perfect! I\'ve created your account, {name}. Let\'s continue with your quote.',
      ...
      SELECT_SERVICE_PERSONALIZED: '⭐ {name}, please select which service you\'d like a quote for:',
      ...
      ADD_MORE_SERVICES: '{name}, would you like to add another service or continue with your quote?',
      MULTIPLE_SERVICES_CONFIRMED: 'Great {name}! You\'ve selected {count} services. Let\'s continue with your quote.',
      BOOKING_AVAILABILITY_PERSONALIZED: '📅 Hello {name}! Of course, I\'d be happy to help you get a quote for another appointment. We have excellent availability today with slots at {times}. If you\'re looking for another day, we have openings tomorrow and this Monday with times starting at 7:00 AM.\n\nPlease let me know what date and time work best for you, and I\'ll prepare your quote right away! 😊',
      BOOKING_REQUEST_PERSONALIZED: '😊 Perfect {name}! I\'d love to help you get a quote.',
      ...
      CLARIFICATION_REQUEST: 'Could you tell me more clearly what you\'d like to do? I can help you get a quote for our services.',
      BOOKING_COMPLETED_FALLBACK: 'Great! Your quote request has been processed.',
      CONTINUE_BOOKING_FALLBACK: 'Let\'s continue with your quote.',
      GETTING_STARTED_FALLBACK: 'Let\'s get started with your quote.',
      REQUEST_COMPLETED_FALLBACK: 'Your request has been completed.',
      CONTINUING_BOOKING_FALLBACK: 'Continuing with your quote...'
    },
  ...
  es: {
    ...
    MESSAGES: {
      ...
      ACCOUNT_CREATED: '¡Perfecto! He creado tu cuenta, {name}. Continuemos con tu cotización.',
      ...
      SELECT_SERVICE_PERSONALIZED: '⭐ {name}, por favor selecciona para cuál servicio te gustaría una cotización:',
      ...
      ADD_MORE_SERVICES: '{name}, ¿te gustaría agregar otro servicio o continuar con tu cotización?',
      MULTIPLE_SERVICES_CONFIRMED: '¡Excelente {name}! Has seleccionado {count} servicios. Continuemos con tu cotización.',
      BOOKING_AVAILABILITY_PERSONALIZED: '📅 ¡Hola {name}! Por supuesto, me encantaría ayudarte a obtener una cotización para otra cita. Tenemos excelente disponibilidad hoy con espacios a las {times}. Si buscas otro día, tenemos aperturas mañana y este lunes con horarios desde las 7:00 AM.\n\n¡Por favor déjame saber qué fecha y hora te funcionan mejor y preparo tu cotización enseguida! 😊',
      BOOKING_REQUEST_PERSONALIZED: '😊 ¡Perfecto {name}! Me encantaría ayudarte a obtener una cotización.',
      ...
      CLARIFICATION_REQUEST: '¿Podrías decirme más claramente qué te gustaría hacer? Puedo ayudarte a obtener una cotización para nuestros servicios.',
      BOOKING_COMPLETED_FALLBACK: '¡Excelente! Tu solicitud de cotización ha sido procesada.',
      CONTINUE_BOOKING_FALLBACK: 'Continuemos con tu cotización.',
      GETTING_STARTED_FALLBACK: 'Comencemos con tu cotización.',
      REQUEST_COMPLETED_FALLBACK: 'Tu solicitud ha sido completada.',
      CONTINUING_BOOKING_FALLBACK: 'Continuando con tu cotización...'
    },
    // Reusable message components for scalable templates
    MESSAGE_COMPONENTS: {
      JOB_DETAILS: {
